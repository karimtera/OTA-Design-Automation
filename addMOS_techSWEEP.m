function netlist = addMOS_techSWEEP(netlist,MOS_TXT_BLOCK,DRAIN,GATE,SOURCE,BULK,WIDTH)
...
MOS_TXT_BLOCK = strrep(MOS_TXT_BLOCK,'L','length*1e-6');
MOS_TXT_BLOCK = strrep(MOS_TXT_BLOCK,'W',[num2str(WIDTH) 'e-6']);
MOS_TXT_BLOCK = strrep(MOS_TXT_BLOCK,'MN','mn');
MOS_TXT_BLOCK = strrep(MOS_TXT_BLOCK,'MP','mp');
